...
import { Archive, ArchiveX, Trash2, Clock, MoreVertical, Pencil } from "lucide-react"; // ✅ MODIFIED: Import Pencil
...
const ThreadDisplay = () => {
  ...
  return (
    // Root container of ThreadDisplay.
    <div className="flex h-full flex-col">
      ...
      {thread ? (
        ...
        <div className="flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
          ...
          {/* Individual EmailDisplay components */}
          ...
          {/* ✅ MODIFIED: Conditionally render ReplyBox or a Reply button */}
