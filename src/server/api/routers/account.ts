...
    return await ctx.db.thread.count({ where: { accountId: input.accountId, ...filter, }, });
  }),
...
        emails: {
          orderBy: { sentAt: "asc", },
          select: { from: true, to: true, cc: true, bcc: true, body: true, bodySnippet: true, emailLabel: true, subject: true, sysLabels: true, id: true, sentAt: true, internetMessageId: true },
        },
      },
      take: 15,
